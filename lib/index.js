(function (global, factory) {
  ...
  module.exports = _React["default"].createClass({
    ...
    propTypes: {
      ...
      radioFactory: _react.PropTypes.func
    },
    ...
    render: function render() {
      ...
      var radioFactory = _props.radioFactory;

      var finalRadioFactory = radioFactory || radio;

      var renderedChildren = children(finalRadioFactory(name, selectedValue, onChange));
